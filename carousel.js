...
class Carousel {
  constructor(el) {
    ...
    this.carouselData = [
      {
        'id': '1',
        'src':'https://i.ibb.co/gZTwDkW/carrousel1.jpg',
      },
      {
        'id': '2',
        'src': 'https://i.ibb.co/HVg7wv5/carrousel2.jpg',
      },
      {
        'id': '3',
        'src': 'https://i.ibb.co/Jd64bDm/carrousel3.jpg',
      },
      {
        'id': '4',
        'src': 'https://i.ibb.co/xmRJLwd/carrousel4.jpg',
      },
      {
        'id': '5',
        'src': 'https://i.ibb.co/MMnKbWC/carrousel5.jpg',
      }
    ];
  ...
  add() {
    ...
    Object.assign(newItem, {
      id: `${lastItem + 1}`,
      src: `https://i.ibb.co/MMnKbWC/carrousel5.jpg${lastItem + 1}`
    });
